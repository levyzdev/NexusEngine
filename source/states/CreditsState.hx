...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Nexus Engine Team'],
			['levyzdev',			'ldev',				'Programmer of Nexus Engine',							 'https://x.com/levyzzdev',			'388EFF'],
			[''], 		
			['Assets'],
			['Marsh',			'',				'Programmer of Verse Events',							 '',			'76A0E3'],
			[''],
			['Psych Engine Team'],
		...
		descBox.makeGraphic(1, 1, 0xFFFFFFFF);
		descBox.color = 0xFF388EFF;
		descBox.xAdd = -10;
		descBox.yAdd = -10;
	...
	override function update(elapsed:Float)
	{
		...
		if(!quitting)
		{
			if(creditsStuff.length > 1)
			{
				...
				{
					descBox.color = CoolUtil.colorFromString(creditsStuff[curSelected][4]);
