...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['You Suck!', 0.15], //From 0% to 19%
		['Shit', 0.3], //From 20% to 39%
		['Bad', 0.5], //From 40% to 49%
		['Bruh', 0.6], //From 50% to 59%
		['Meh', 0.65], //From 60% to 68%
		['Nice', 0.7], //69%
	...
	override public function create()
	{
		...
		scoreTxt.setFormat(Paths.font("osu.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	function startSong():Void
	{
		...
		if(autoUpdateRPC) DiscordClient.changePresence(detailsText, SONG.song + " | " + storyDifficultyText + " | " + "Misses: " + songMisses + " | ", iconP2.getCharacter(), true, songLength);
		#end
	...
	{
		#if DISCORD_ALLOWED
		if (health > 0 && !paused && autoUpdateRPC) DiscordClient.changePresence(detailsPausedText, SONG.song + " | " + storyDifficultyText + "" + " | " + "Misses: " + songMisses + " | ", iconP2.getCharacter());
		#end
	...
	function openPauseMenu()
	{
		...
		#if DISCORD_ALLOWED
		if(autoUpdateRPC) DiscordClient.changePresence(detailsPausedText, SONG.song + " | " + storyDifficultyText + "" + " | " + "Misses: " + songMisses + " | ", iconP2.getCharacter());
		#end
	}
	...
	function doDeathCheck(?skipHealthCheck:Bool = false) {
		if (((skipHealthCheck && instakillOnMiss) || health <= 0) && !practiceMode && !isDead)
		{
			...
			if(ret != LuaUtils.Function_Stop) {
				...
				if(autoUpdateRPC) DiscordClient.changePresence("Game Over - " + detailsText, SONG.song + " | " + storyDifficultyText + "" + " | " + "Misses: " + songMisses + " | ", iconP2.getCharacter());
				#end
				isDead = true;
				return true;
			}
	...
	public function endSong()
	{
		...
		if(ret != LuaUtils.Function_Stop && !transitioning)
		{
			...
			if (isStoryMode)
			{
				...
				{
					Mods.loadTopMod();
					FlxG.sound.playMusic(Paths.music(ClientPrefs.data.menuSong));
					#if DISCORD_ALLOWED DiscordClient.resetClientID(); #end
