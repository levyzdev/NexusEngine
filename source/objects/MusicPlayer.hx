...
class MusicPlayer extends FlxGroup 
{
	...
	override function update(elapsed:Float)
	{
		...
		if (paused && !wasPlaying){
			...
			DiscordClient.changePresence("Playing: " + instance.songs[FreeplayState.curSelected].songName +  " (PAUSED)", null);
         } else { 
			songTxt.text = 'PLAYING: ' + instance.songs[FreeplayState.curSelected].songName;
			DiscordClient.changePresence("Playing: " + instance.songs[FreeplayState.curSelected].songName, null);
	    }
		positionSong();
